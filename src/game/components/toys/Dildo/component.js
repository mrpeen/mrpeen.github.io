  ...
  <svg className="Dildo" viewBox="0 0 253.8 187.33">
    <g id="Ebene_2">
      <g id="Realistic_Dildo">
        ...
        <path d="M138.06,4A47,47,0,0,1,145,20.33c5.93,27.62-13.86,55.25-44.17,61.76S41.1,71.48,35.17,43.86a46.89,46.89,0,0,1-.39-17.71" fill="#ffc9ef" stroke="#ffabe6" strokeLinecap="round" strokeWidth="8"/>
      </g>
    </g>
  </svg>
);
